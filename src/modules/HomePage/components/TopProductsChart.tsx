        ...
        <div className="flex flex-wrap items-center gap-2">
          <Select value={metric} onValueChange={(value) => setMetric(value as 'sales' | 'revenue')}>
            <SelectTrigger className="h-8 w-[120px]">
              <SelectValue placeholder="Chỉ sốsố" />
            </SelectTrigger>
            <SelectContent>
            ...
            >
              ...
              <Tooltip
                formatter={(value, name) => {
                  if (name === 'revenue') {
                    return [`${formatCurrency(Number(value))}`, 'Doanh thuthu'];
                  }
              ...
              {metric === 'sales' ? (
                ...
                <Bar dataKey="revenue" fill="#8884d8" name="Doanh thu" radius={[0, 4, 4, 0]} barSize={32} />
              )}
            </BarChart>
          </ResponsiveContainer>
        )}
