...
export const env = {
  ...
  CHAIN_RPC_URL:
    ENV.NEXT_PUBLIC_CHAIN_RPC_URL ?? 'https://evmrpc-testnet.0g.ai',
};

export const LAST_MONTH = new Date(
...
export const SMART_CONTRACT_ADDRESS = (
  ENV.NEXT_PUBLIC_SMART_CONTRACT_ADDRESS ??
